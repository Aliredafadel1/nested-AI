...
class StudentProfile(Base):
    ...
    preference_vector: Mapped[list | None] = mapped_column(Vector(384))
    dim_sleep:         Mapped[list | None] = mapped_column(Vector(384))
    dim_study:         Mapped[list | None] = mapped_column(Vector(384))
    dim_cleanliness:   Mapped[list | None] = mapped_column(Vector(384))
    dim_guests:        Mapped[list | None] = mapped_column(Vector(384))
    dim_budget:        Mapped[list | None] = mapped_column(Vector(384))
