  ...
  const send = async (text: string) => {
    ...
    const tryStream = () =>
      streamChat(
        ...
        (text) => setProgress(text),   // progress handler
      )
    tryStream()
  }
  ...
  return (
    <div className="flex flex-col h-full min-h-[400px]">
      <div className="flex-1 overflow-y-auto px-4 py-3">
        ...
        {/* Live progress indicator — shown between user message and first token */}
        {progress && (
      ...
      <div className="border-t px-4 py-3 bg-white">
        ...
        <div className="flex gap-2 mt-2">
          <input
            className="flex-1 border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30"
            placeholder="Ask about listings, areas, generator hours…"
            value={input}
